...
def test_mask_account_card(bank_data: str, masked_data: str) -> None:
...
def bank_datas(request: pytest.FixtureRequest) -> str:
    return cast(str, request.param)


def test_mask_account_card_incorrect(bank_datas: str) -> None:
    with pytest.raises(ValueError):
        mask_account_card(bank_datas)


@pytest.mark.parametrize('init_data, correct_data', zip(           # тестирование корректных данных
    ['2024-03-11T02:26:18.671407', '2025-12-20T12:21:48.683407', '1988-07-31T23:59:59.999999'],
    ['11.03.2024', '20.12.2025', '31.07.1988']))
def test_get_date(init_data: str, correct_data: str) -> None:
...
@pytest.fixture(params=['2024-02-30T02:58:18.671407',  # тестируем некорректное число месяца
                        ...
                        '20209-10-30T02:58:18.671407',   # тестируем некорректный формат года (должно быть 4 символа)
...
def list_dates(request: pytest.FixtureRequest) -> str:
    return cast(str, request.param)


def test_get_date_incorrect(list_dates: str) -> None:
    with pytest.raises(ValueError):
        get_date(list_dates)
